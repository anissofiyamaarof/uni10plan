                ...
                <div class="bg-white border rounded shadow-sm overflow-hidden">
                    ...
                    <form action="#!">
                        <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                            ...
                            <!--START additional column in assigning project-->

                            <div class="col-12">
                                <label for="system_pic_id" class="form-label">System PIC Name <span class="text-danger">*</span></label>
                                <select class="form-control" id="system_pic_id" name="system_pic_id" required readonly>
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-control" id="lead_developer_id" name="lead_developer_id" required readonly>
                                    @foreach($users as $user)
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="developer_id" name="developer_id" value="{{ implode(', ', $project->developers->pluck('name')->toArray()) }}" required readonly>
                            </div>

                            <div class="col-12">
                                <label for="startDate" class="form-label">Project Start Date <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="startDate" name="startDate" value="{{ $project->startDate }}" required readonly>
                            </div>
                            <div class="col-12">
                                <label for="endDate" class="form-label">Project End Date <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="endDate" name="endDate" value="{{ $project->endDate }}" required readonly>
                            </div>
                            <div class="col-12">
                            ...
                            <!--END additional column in assigning project-->
