    ...
    <div class="container mt-4">
        <div class="row justify-content-md-center">
            <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                <h2 class="mb-4 display-5 text-center">Assign The Project</h2>
        ...
        <div class="row justify-content-lg-center">
            <div class="col-12 col-lg-9">
                <div class="bg-white border rounded shadow-sm overflow-hidden">
                    ...
                    <form method="POST" action="{{route('project.assignProject', ['id' => $project->id])}}">
                        @csrf
                        <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="duration" name="duration" value="" required readonly>
                            </div>
